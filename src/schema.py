...
Validation checks:
    - top-level keys are a subset of {"thought", "tool_call", "final_answer"}
    - exactly one of "tool_call" or "final_answer" is present
    - "tool_call.name" is a string registered in TOOL_REGISTRY
    - "tool_call.arguments" is a dict with expected parameter names
    - no extra or unknown argument keys
"""
...
def check_dependencies(
    ...
    Args:
        ...
        dependency_graph: TOOL_DEPENDENCIES mapping tool -> set of prerequisite tools.
